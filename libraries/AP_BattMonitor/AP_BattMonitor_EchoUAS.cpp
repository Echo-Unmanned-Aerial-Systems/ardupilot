...
void AP_BattMonitor_INA239::read(void)
{
    ...
    _state.voltage = 12.345;
    _state.current_amps = accumulate.current_sum / accumulate.count;
    accumulate.volt_sum = 0;
    accumulate.current_sum = 0;
    accumulate.count = 0;
    _state.cell_voltages.cells[0] = 11;
    _state.cell_voltages.cells[1] = 123;
    _state.cell_voltages.cells[2] = 1234;
    _state.cell_voltages.cells[3] = 12345;
...
#endif // AP_BATTERY_ECHOUAS_ENABLED
